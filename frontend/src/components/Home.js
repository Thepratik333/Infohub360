...
const Home = () => {
    ...
    useEffect(() => {
        ...
        gsap.to(".main", {
            background: "linear-gradient(rgb(2, 0, 36) 0%, rgb(0 0 0) 16%, rgb(26, 153, 179) 100%) rgb(255, 255, 255)",
            scrollTrigger: {
                trigger: ".main",
                scroller: "body",
                start: "top 5%",
            ...
            <div className="main">
                ...
                <div data-scroll data-scroll-speed="-10" id="page1">
                    <div className="mainText">
                        <h1 className="h1">Your Gateway to a </h1>
                        <h2 className="h2">World of Knowledge,</h2>
                        <h3 className="h3"> Insight, and Exploration</h3>
                    </div>
                    <div className="scroller">
                        <div className="alphaScroller">
                            <h4>NEWSCHUNK </h4>
                            <h4>INOTEBOOK</h4>
                            <h4>WORD COUNTER</h4>
                            <h4>NOTES</h4>
                    ...
                    <div className="cards-container">
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title">NewsChunk</h5>
                                <p className="card-text">
                                    "Stay informed effortlessly with NewsChunk, your one-stop
                                    destination for comprehensive news coverage across all
                                    channels."
                                </p>
                        ...
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    "Empower your productivity with InoteBook, the ultimate
                                    destination for intuitive note-taking and seamless
                                    organization."
                                </p>
                        ...
                        <div className="card" style={{ width: "18rem" }}>
                            <img src={word} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h5 className="card-title">Word Counter</h5>
                                <p className="card-text">
                                    "Track and optimize content with our word counter website,
                                    your essential tool for precise and efficient text analysis."
                                </p>
                                <Link to="/word/" className="btn btn-primary">
                                    Click here{" "}
                                </Link>
                            </div>
                        </div>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    "Experience real-time weather and go-to for accurate
                                    forecasts, live updates, and personalized weather
                                    information."
                                </p>
                        ...
                        <div className="card" style={{ width: "18rem" }}>
                            <img src={converter} className="card-img-top" alt="..." />
                            <div className="card-body">
                ...
                <div id="page3" style={{padding: "30px", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center"}}>
                    <div className="contact container">
                        ...
                        <form>
                            <h1 className="title text-center mb-4 text-white">Talk to Us</h1>
                            ...
                            <div className="text-center position-relative">
                                <button type="submit" className="submit" tabIndex="-1">
                                    Send message
                                </button>
                            </div>
                        </form>
